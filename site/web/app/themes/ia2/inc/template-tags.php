...
function twentysixteen_entry_taxonomies() {
	...
	if ( $categories_list && twentysixteen_categorized_blog() ) {
		printf( '<span class="cat-links"><span class="screen-reader-text"></i> %1$s </span>%2$s</span>',
...
function twentysixteen_post_thumbnail() {
	...
	<div class="entry-thumb post-thumbnail">
	...
	<a class="post-thumbnail entry-thumb" href="<?php the_permalink(); ?>" aria-hidden="true">
