                ...
                <div layout="column" flex id="content">
                    <md-content layout="column" flex class="md-padding">
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            Thank you for registered as an Publisher with Intentaware.com
                        </div>
                        ...
                        <md-content class="md-padding" ng-hide="submitted">
                            <form name="userForm" ng-submit="submitForm()" novalidate>
                                ...
                                <input type="text" name="is_publisher" ng-model="user.is_publisher" initial-value="true" style="display: none;">
